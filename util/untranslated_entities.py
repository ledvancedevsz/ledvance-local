...
def error_location(entity):
    return f"::error file=custom_components/ledvance/devices/{entity._device.config},line={entity._config.__line__}:"


def main() -> int:
    with open("custom_components/ledvance/translations/en.json", "r") as f:
